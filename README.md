...
server parameterizes those literals itself; the 1000-table benchmark ran 27% faster overall and its
first write into each table three times faster (specs/012). It is a database-wide option, so it has
